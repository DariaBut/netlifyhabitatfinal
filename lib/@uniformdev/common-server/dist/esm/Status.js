            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        obj = existsSync(statusPath)
                            ? JSON.parse(readFileSync(statusPath).toString())
                            : undefined;
                        time = existsSync(timerPath) ? JSON.parse(readFileSync(timerPath).toString()) : undefined;
                        if (!obj || !time) {
                            return [2 /*return*/, undefined];
                        }
                        if (!getBoolEnv(process.env, 'UNIFORM_EXPORT_PRECISE_PROGRESS_ENABLED', false)) return [3 /*break*/, 2];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _b = obj;
                        return [4 /*yield*/, countFiles(outputDir, '.html')];
                    case 2:
                        _b.processed = _d.sent();
                        return [3 /*break*/, 5];
                    case 3:
                        _c = obj;
                        return [4 /*yield*/, countFiles(outputDir, '.txt')];
                    case 4:
