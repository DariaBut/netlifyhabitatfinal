...
export function exportPathMap(logger) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    config = parseUniformServerConfig(process.env, logger);
                    tmp = config.UNIFORM_PUBLISH_TEMP_DIR;
                    if (existsSync(tmp + '/.publish-map.json')) {
                        logger.info('Parsing .publish-map.json...');
                        map = JSON.parse(readFileSync(tmp + '/.publish-map.json').toString());
                ...
                case 3:
                    ex_1 = _a.sent();
                    logger.error('Failed to export path map', errorToJsonObject(ex_1));
                    throw ex_1;
