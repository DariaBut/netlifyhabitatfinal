...
export function attachDeploymentStatusMiddleware(server, tempDir, uniformConfig, logger) {
    server.get('/uniform/api/deployment/status/:ticket', getDeploymentStatusMiddleware(tempDir, uniformConfig, logger));
}
export function getDeploymentStatusMiddleware(tempDir, uniformConfig, logger) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, BuildDeployService.status(outputDir)];
                    case 1:
                        status = (_a.sent()) || {
                            status: 'Error',
