...
exports.downloadSiteMap = void 0;
...
function downloadSiteMap(config, logger) {
    return __awaiter(this, void 0, void 0, function () {
        function doDownloadSiteMap(suffix, apiUrl) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, common_2.fetchWithRetry(node_fetch_1.default, logger, apiUrl, 3, parseInt(common_1.getEnv(config.env, 'UNIFORM_PUBLISH_MAP_REQUEST_TIMEOUT', '90000')))];
                        case 1:
                            response = _a.sent();
        ...
        var mapServiceEndpoint, suffix, filename, _a, _b, uniformApiToken, ex_1, attempt, sitemap, ex_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    uniformApiToken = common_1.getEnv(process.env, 'UNIFORM_API_TOKEN', undefined);
                    _c.label = 4;
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, doDownloadSiteMap(suffix, common_1.getApiUrlWithToken(config, suffix, uniformApiToken))];
...
exports.downloadSiteMap = downloadSiteMap;
