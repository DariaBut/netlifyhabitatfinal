...
var isDebug = common_1.getBoolEnv(process.env, 'UNIFORM_OPTIONS_DEBUG', false);
...
if (typeof window === 'undefined') {
    var fileTransport = new winston_1.transports.File({ filename: '.debug.log', level: 'debug' });
    loggerTransports.push(fileTransport);
}
exports.serverLogger = winston_1.createLogger({
