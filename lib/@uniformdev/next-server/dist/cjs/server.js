...
function server(_a) {
    ...
    } : _a, _c = _b.logger, logger = _c === void 0 ? common_server_1.serverLogger : _c, createPublishProvider = _b.createPublishProvider, _d = _b.extensionFilter, extensionFilter = _d === void 0 ? defaultExtensionFilter : _d, _e = _b.pathFilter, pathFilter = _e === void 0 ? defaultPathFilter : _e;
    if (!logger) {
    ...
    var createAndStartUniformServer = function (nextServer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        buildAndExportEngine = new _1.NextBuildAndExportEngine();
