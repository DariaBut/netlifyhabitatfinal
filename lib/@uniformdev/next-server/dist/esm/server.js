...
import { createUniformServer, startUniformServer, parseUniformServerConfig, UniformServerMode, serverLogger, } from '@uniformdev/common-server';
import { NextBuildAndExportEngine } from '.';
...
export function server(_a) {
    var _this = this;
    var _b = _a === void 0 ? {
        logger: serverLogger,
        extensionFilter: defaultExtensionFilter,
        pathFilter: defaultPathFilter,
    } : _a, _c = _b.logger, logger = _c === void 0 ? serverLogger : _c, createPublishProvider = _b.createPublishProvider, _d = _b.extensionFilter, extensionFilter = _d === void 0 ? defaultExtensionFilter : _d, _e = _b.pathFilter, pathFilter = _e === void 0 ? defaultPathFilter : _e;
    if (!logger) {
    ...
    var uniformServerConfig = parseUniformServerConfig(process.env, logger);
    logger.info("NODE_ENV: " + process.env.NODE_ENV);
    var createAndStartUniformServer = function (nextServer) {
        return __awaiter(this, void 0, void 0, function () {
            var buildAndExportEngine, server, handler_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        buildAndExportEngine = new NextBuildAndExportEngine();
                        return [4 /*yield*/, createUniformServer(buildAndExportEngine, logger, {
    ...
    var data = uniformServerConfig.UNIFORM_CONTENT_URL;
    logger.info('Data URL: ' + data);
    var exportCommand = getEnv(process.env, 'UNIFORM_PUBLISH_NEXT_EXPORT_COMMAND', '').trim();
    ...
    if (mode === UniformServerMode.publish) {
        ...
        var app_1 = next({ dev: process.env.NODE_ENV !== 'production' });
