...
import { buildLayout } from '@uniformdev/common-client';
...
var PageComponentClass = /** @class */ (function (_super) {
    ...
    function PageComponentClass(props) {
        ...
        _this.state = { placeholders: buildLayout(props, true) };
        _this.logger = (props.uniformContext && props.uniformContext.logger) || throwException('logger');
        return _this;
    }
    ...
    PageComponentClass.prototype.createRenderingContext = function () {
        ...
        var placeholders = buildLayout(this.props, true);
        ...
        return {
            ...
            home: props.home || props.item || throwException('no home'),
...
export var PageComponent = withUniformContext(PageComponentClass);
