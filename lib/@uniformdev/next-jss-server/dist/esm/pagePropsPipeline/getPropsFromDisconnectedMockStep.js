...
export var getPropsFromDisconnectedMockStep = {
    ...
    run: function (context) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!(typeof window === 'undefined' && isExportProcess())) return [3 /*break*/, 3];
                    if (!(process.env.JSS_MODE === 'disconnected')) return [3 /*break*/, 3];
                    return [4 /*yield*/, initializeDataServices(context)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, Promise.all([
                            fetchMockLayoutServiceData(dataServices.layoutService, context.routeParams.sitecoreRoute, context.routeParams.lang),
