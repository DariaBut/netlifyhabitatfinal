...
export var getDisconnectedExportPathMap = function (_a) {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    _a = getNextServerConfig(), jssAppName = _a.jssAppName, defaultLanguage = _a.defaultLanguage, appLanguages = _a.appLanguages;
                    manifestPathMap = {};
                    _g.label = 1;
                case 1:
