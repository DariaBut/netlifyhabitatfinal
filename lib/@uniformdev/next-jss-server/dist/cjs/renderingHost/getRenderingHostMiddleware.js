...
exports.getJssRenderingHostMiddleware = void 0;
var url_1 = require("url");
var renderToHTML_1 = require("./renderToHTML");
var resolveJSSData_1 = require("./resolveJSSData");
var api_utils_1 = require("next/dist/next-server/server/api-utils");
function getJssRenderingHostMiddleware(app, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        jssData = resolveJSSData_1.resolveJssDataFromWebhookRequest(req);
                        ...
                        req[api_utils_1.SYMBOL_PREVIEW_DATA] = jssData;
                        parsedUrl = url_1.parse(jssData.renderPath, true);
                        routeInfo = {
                        ...
                        return [4 /*yield*/, renderToHTML_1.renderToHTML(app, req, routeInfo.pathname, routeInfo.params)];
                    case 2:
                        html = _a.sent();
...
exports.getJssRenderingHostMiddleware = getJssRenderingHostMiddleware;
