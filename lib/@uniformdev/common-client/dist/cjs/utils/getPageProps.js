...
function getPageItem(fetch, path, logger, config) {
...
function getDataItem(fetch, path, type, logger, config) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, common_1.fetchWithRetry(fetch, logger, itemUrl, 3)];
                case 4:
                    response = _c.sent();
...
function getPageProps(fetch, asPath, config, logger) {
