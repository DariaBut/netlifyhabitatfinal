...
export function getClientScriptLoader() {
    return {
        type: 'default',
...
function loadClientScripts(scripts, args) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = args.cachedScripts, cachedScripts = _a === void 0 ? {} : _a, callback = args.callback, _b = args.logger, logger = _b === void 0 ? getNullLogger() : _b;
