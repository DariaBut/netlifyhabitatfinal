...
export function getPageItem(fetch, path, logger, config) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getDataItem(fetch, path, 'page', logger, config)];
...
export function getDataItem(fetch, path, type, logger, config) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, fetchWithRetry(fetch, logger, itemUrl, 3)];
                case 4:
                    response = _c.sent();
...
export function getPageProps(fetch, asPath, config, logger) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getPageItem(fetch, path, logger, config)];
                case 1:
                    item = _a.sent();
                    home = item;
